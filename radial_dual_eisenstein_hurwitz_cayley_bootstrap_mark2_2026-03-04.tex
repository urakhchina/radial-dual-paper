...
\caption{Radial dual lattice graphs with zone-colored edges. \textbf{(a)} Eisenstein
lattice graph with $r=1$, $R=4$. Red/blue edges show the graph isomorphism
between outer and inner zones. Inset: magnified inner zone. \textbf{(b)} E8
radial dual projected to 3D via $H_{4\mathrm{fold}}$, inversion, and FIG
slice, zone-colored to match.}
